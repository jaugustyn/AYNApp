...
namespace CalendarAPI.Controllers
{
    ...
    public class CalendarController : ControllerBase
    {
        ...
        public async Task<ActionResult<IQueryable<Calendar>>> GetMyCalendars()
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Calendar>> PostCalendar(ManipulationCalendarDto calendarDto)
        {
            var userId = Guid.Parse(User.FindFirstValue(ClaimTypes.NameIdentifier));
